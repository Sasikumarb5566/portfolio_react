    ...
    <div className="flex flex-col md:flex-row md:justify-around mt-40 items-center md:pb-32 pb-32">
      <div className="text-center md:text-start">
        <div>
          ...
          <p className="text-4xl md:text-6xl font-bold mt-2 text-gray-500">I'm <span className="text-[#252829]">Sasikumar</span></p>
          <p className="text-3xl md:text-3xl text-gray-500 font-semibold mt-2">MERN Stack Developer</p>
        </div>
        <div className="flex gap-8 mt-8 justify-center md:justify-start">
          ...
          <a href="#contact"><button className="bg-[#252829] text-white px-4 py-2 border-2 rounded-full border-slate-800 hover:bg-white hover:text-black hover:border-slate-800 shadow-xl transition ease-in-out delay-50">
            Contact Info
          </button></a>
        </div>
      </div>
